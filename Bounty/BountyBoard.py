        ...
        for bounty in self.bounties:
            if bounty.name.lower() == bounty_name.lower():
                if not bounty.completed:
                    ...
                    await bounty.poster.send(f"Your bounty '{bounty.name}' has been completed.")
                    return
        ...
        for bounty in self.bounties:
            if bounty.name.lower() == bounty_name.lower():
                if not bounty.taken:
                    ...
                    await bounty.poster.send(f"Your bounty '{bounty.name}' has been taken up and is now pending.")
                    return
                else:
