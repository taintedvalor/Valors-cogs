...
class BountyBoard(commands.Cog):
    def __init__(self, bot):
        ...
        default_guild_config = {
            ...
            "bounty_channel": None,
            "enable_reward_question": True,
            "enable_supervisor_question": True
        }
    ...
    async def create_bounty(self, ctx, name, *, description):
        ...
        enable_reward_question = await self.config.guild(ctx.guild).enable_reward_question()
        if enable_reward_question:
        ...
        enable_supervisor_question = await self.config.guild(ctx.guild).enable_supervisor_question()
        if enable_supervisor_question:
    ...
    async def add_star(self, ctx, member: discord.Member):
    ...
    async def remove_star(self, ctx, member: discord.Member):
    ...
    async def count_stars(self, ctx, member: discord.Member):
