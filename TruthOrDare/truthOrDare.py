...
class TruthOrDare(commands.Cog):
    ...
    async def tod(self, ctx):
        ...
        truth_button = Button(style=3, label="Truth", emoji="🔍")
        dare_button = Button(style=3, label="Dare", emoji="🎯")
        nsfw_button = Button(style=3, label="NSFW", emoji="🔞")
    ...
    async def nsfw_options(self, ctx):
        truth_button = Button(style=3, label="Truth (NSFW)", emoji="🔍")
        dare_button = Button(style=3, label="Dare (NSFW)", emoji="🎯")
        back_button = Button(style=2, label="Back", emoji="↩️")
